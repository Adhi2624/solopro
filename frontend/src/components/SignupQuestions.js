  ...
  const SignupQuestions = () => {
    ...
    const handleSubmit = async () => {
      ...
      formDataToSubmit.append("profileImage", profileImage); // Assuming this is a File object
      formDataToSubmit.append("proofImage", proofImage);     // Assuming this is a File object

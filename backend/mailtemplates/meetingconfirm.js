...
const meetingconf = async (sourceemail, destinationemail, sourcename, destinationname, title, startDate, startTime, endDate, endTime, meetinglink, meetingStatus) => {
    ...
    const htmlTemplateconf = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<![endif]--><!--[if !mso]><!-- -->
  ...
  <style type="text/css">
    body{
      font-family: 'Montserrat', sans-serif !important; /* Montserrat font applied */
                 ...
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:540px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     ...
                     <tr>
                      <td align="center" style="padding:0;Margin:0;padding-top:30px"><p style="Margin:0;mso-line-height-rule:exactly;font-family:'Exo 2', sans-serif;line-height:36px;letter-spacing:0;color:#666666;font-size:18px">Hi <strong>${destinationname}</strong>!</p></td>
                     </tr>
                     <tr>
                      <td align="center" style="padding:0;Margin:0;padding-top:5px"><p style="Margin:0;mso-line-height-rule:exactly;font-family:'Exo 2', sans-serif;line-height:36px;letter-spacing:0;color:#666666;font-size:18px">Your Meeting with&nbsp;<strong>${sourcename}&nbsp;</strong>has been approved.</p></td>
                     </tr>
                     <tr>
                      <td align="center" style="padding:0;Margin:0;padding-top:5px"><p style="Margin:0;mso-line-height-rule:exactly;font-family:'Exo 2', sans-serif;line-height:36px;letter-spacing:0;color:#666666;font-size:18px">Join meet on time or click here to redirect to meeting</p></td>
                     </tr>
                     <tr>
...
<![endif]--><!--[if !mso]><!-- --><span class="es-button-border msohide" style="border-style:solid;border-color:#FFDDA9;background:#010506;border-width:0px 0px 2px 0px;display:inline-block;border-radius:30px;width:auto;mso-hide:all"><a href=${meetinglink} class="es-button es-button-7775" target="_blank" style="mso-style-priority:100 !important;text-decoration:none !important;mso-line-height-rule:exactly;color:#ffffff;font-size:20px;padding:15px 30px 15px 30px;display:inline-block;background:#010506;border-radius:30px;font-family:'Exo 2', sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center;letter-spacing:0;mso-padding-alt:0;mso-border-alt:10px solid #010506">Join Meet</a></span><!--<![endif]--></td>
<table style="width: 100%; border-collapse: collapse; margin-bottom: 20px; border: 1px solid black; margin-top: 50px;">
  <thead>
      <tr>
          <th style="padding: 12px; text-align: left; border-bottom: 1px solid #ddd; background-color: #4CAF50; color: white;">Mentor Name</th>
          <th style="padding: 12px; text-align: left; border-bottom: 1px solid #ddd; background-color: #4CAF50; color: white;">Meeting Title</th>
          <th style="padding: 12px; text-align: left; border-bottom: 1px solid #ddd; background-color: #4CAF50; color: white;">Meeting Timing</th>
      </tr>
  </thead>
  <tbody>
      <tr style="background-color: #f2f2f2;">
          <td style="padding: 12px; text-align: left; border-bottom: 1px solid #ddd;">${sourcename}</td>
          <td style="padding: 12px; text-align: left; border-bottom: 1px solid #ddd;">${title}</td>
          <td style="padding: 12px; text-align: left; border-bottom: 1px solid #ddd;">${startDate} - ${startTime}</td>
      </tr>
...
const meetingrej = async(sourceemail, destinationemail, sourcename, destinationname, title, startDate, startTime, endDate, endTime, meetinglink, meetingStatus)=>{
  console.log(sourceemail, destinationemail, sourcename, destinationname)
  const htmlTemplateconf=`<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="en">
 <head>
               ...
               <table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:540px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="center" style="padding:0;Margin:0"><h1 style="Margin:0;font-family:'Exo 2', sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:36px;font-style:normal;font-weight:bold;line-height:43px;color:#000000">Meeting Request Rejected</h1></td>
                     </tr>
                     <tr>
                      <td align="center" style="padding:0;Margin:0;padding-top:20px;font-size:0px"><img class="adapt-img" src="https://ehqwuij.stripocdn.email/content/guids/7e841d84-a07e-4500-b4bb-7eeeb9b5370d/images/g60a23af8a010de4daf16f785aa4b00a0147b7dbe6bde5ecaa2214c858b1eae0f8cb1bdb4dd3874c7312c231abdc4df4e_640.png" alt="" style="display:block;font-size:18px;border:0;outline:none;text-decoration:none" width="540"></td>
                     </tr>
                     ...
                     <tr>
                      <td align="center" style="padding:0;Margin:0;padding-top:5px"><p style="Margin:0;mso-line-height-rule:exactly;font-family:'Exo 2', sans-serif;line-height:36px;letter-spacing:0;color:#666666;font-size:18px">We are sorry to inform you that your Meeting with&nbsp;<strong>${sourcename}&nbsp;</strong>has been Rejected by ${sourcename}<br>We are not sure about the reason, but keep trying other mentors on Solopro to kickstart your amazing journey .</p></td>
                     </tr>
...
<table style="width: 100%; border-collapse: collapse; margin-bottom: 20px; border: 1px solid black; margin-top: 50px;">
  <thead>
      <tr>
          <th style="padding: 12px; text-align: left; border-bottom: 1px solid #ddd; background-color: #ff0000; color: white;">Mentor Name</th>
          <th style="padding: 12px; text-align: left; border-bottom: 1px solid #ddd; background-color: red; color: white;">Meeting Title</th>
          <th style="padding: 12px; text-align: left; border-bottom: 1px solid #ddd; background-color: red; color: white;">Meeting Timing</th>
      </tr>
  </thead>
  <tbody>
      <tr style="background-color: #f2f2f2;">
          <td style="padding: 12px; text-align: left; border-bottom: 1px solid #ddd;background-color: #ff0000;color: white;">${sourcename}</td>
          <td style="padding: 12px; text-align: left; border-bottom: 1px solid #ddd;background-color: #ff0000;color: white;">${title}</td>
          <td style="padding: 12px; text-align: left; border-bottom: 1px solid #ddd;background-color: #ff0000;color: white;">${startDate} - ${startTime}</td>
      </tr>
...
<tr>
  ...
  const mailOptions = {
    ...
    subject: 'SOLOPRO - Meeting status Update', // Subject line
    html: htmlTemplateconf, // html body
};
...
module.exports = meetingconf,meetingrej;
